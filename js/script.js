/**
 * @author Tech GEDR <gobinda90021@gmail.com>
 */
(function ($) {
  "use strict";
  $(".techgedr-falling").sakura("start", {
...
var countDownDate = new Date("December 06, 2024 13:26:00").getTime();
...
console.log("\n\n%c SAVE THE DATE: 06th Dec, 2024", styles);
